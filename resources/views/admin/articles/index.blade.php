...
@section('content')
    <div x-data="{
        search: '',
        matches(articleTitle) {
            return this.search === '' || articleTitle.toLowerCase().includes(this.search.toLowerCase());
        }
    }"
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Manajemen Artikel</h1>
                </div>
                <p class="text-gray-600 dark:text-gray-400">Kelola dan atur semua artikel Anda</p>
            </div>
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="relative w-full sm:w-80">
                        ...
                        <input type="text" x-model="search" placeholder="Cari judul artikel..."
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($articles as $article)
                                <tr x-show="matches('{{ addslashes(strtolower($article->title)) }}')"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <form action="{{ route('admin.articles.destroy', $article) }}" method="POST"
                                                class="inline-block" onsubmit="return confirm('Yakin hapus artikel ini?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center space-y-3">
                                            ...
                                            <p class="text-sm text-gray-400 dark:text-gray-500">Mulai dengan membuat artikel
                                                pertama Anda</p>
                                        </div>
                                    </td>
                                </tr>
