...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
    <div class="container mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">Buat kategori baru untuk mengorganisir artikel</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('admin.category.store') }}" method="POST" novalidate class="p-6 sm:p-8 space-y-6">
                @csrf
