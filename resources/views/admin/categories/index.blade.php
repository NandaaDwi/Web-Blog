        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Manajemen Kategori</h1>
                </div>
                <p class="text-gray-600 dark:text-gray-400">Kelola dan atur semua kategori artikel</p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($categories as $i => $cat)
                                <tr x-show="matches('{{ addslashes(strtolower($cat->name)) }}')"
                                    class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                    <td class="px-6 py-4 text-center">
                                        <span
                                            class="inline-flex items-center justify-center w-8 h-8 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 rounded-full text-sm font-semibold">
                                ...
                                <tr x-show="search === ''">
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center space-y-3">
                                            ...
                                            <p class="text-sm text-gray-400 dark:text-gray-500">Mulai dengan membuat
                                                kategori pertama</p>
                                        </div>
                                    </td>
                                </tr>
