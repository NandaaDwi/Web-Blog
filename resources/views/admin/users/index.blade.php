...
<div x-data="{
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">Kelola dan atur semua pengguna sistem</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="relative w-full sm:w-80">
                    ...
                    <input type="text" x-model="search" placeholder="Cari nama, email, atau role..."
                            ...
                            <tr x-show="matches({
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                        @if($user->role === 'admin') bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300
                                        @elseif($user->role === 'editor') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center space-y-3">
                                        ...
                                        <p class="text-sm text-gray-400 dark:text-gray-500">Mulai dengan membuat user pertama</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
