...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
    <div class="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">Ubah dan simpan perubahan artikel Anda</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('editor.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 max-h-60 overflow-y-auto border rounded-lg p-4 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 @error('categories') border-red-500 dark:border-red-400 @enderror">
                        @php
                            $oldCategories = old('categories', $article->categories->pluck('id')->toArray());
                        @endphp
                ...
                <div class="space-y-4">
                    ...
                    <div class="mt-3">
                        @if($article->thumbnail)
                            <img id="thumbnailPreview" src="{{ asset('storage/' . $article->thumbnail) }}" alt="Preview Thumbnail"
